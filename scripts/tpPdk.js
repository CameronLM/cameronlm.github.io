...
v[Db]=function(){return String($pdk.env.Detect.getInstance().hasFlash())};u[Db]={'false':0,'true':1};v[Eb]=function(){return String($pdk.env.Detect.getInstance().hasJquery())};u[Eb]={'false':0,'true':1};v[Fb]=function(){var a=$pdk.env.Detect.getInstance().getConfigSet(Gb);return a&&a.contains(Hb)?Ib:Jb};u[Fb]={'false':0,'true':1};v[Kb]=function(){var b=navigator.userAgent.toLowerCase();var c=function(a){return parseInt(a[1])*1000+parseInt(a[2])};if(function(){return b.indexOf(Lb)!=-1&&b.indexOf(Mb)!=-1||b.indexOf(Nb)!=-1}()){{m.$pdk.userAgentAxis=Ob;return m.$pdk.userAgentAxis}}if(function(){return b.indexOf(Pb)!=-1||b.indexOf(Qb)!=-1}()){{m.$pdk.userAgentAxis=Rb;return m.$pdk.userAgentAxis}}if(function(){return b.indexOf(Lb)!=-1&&(b.indexOf(Pb)==-1&&(b.indexOf(Qb)==-1&&b.indexOf(Nb)==-1))}()){{m.$pdk.userAgentAxis=Sb;return m.$pdk.userAgentAxis}}if(function(){return b.indexOf(Tb)!=-1}()){{m.$pdk.userAgentAxis=Tb;return m.$pdk.userAgentAxis}}if(function(){return b.indexOf(Ub)!=-1}()){{m.$pdk.userAgentAxis=Vb;return m.$pdk.userAgentAxis}}if(function(){return b.indexOf(Wb)!=-1}()){{m.$pdk.userAgentAxis=Xb;return m.$pdk.userAgentAxis}}if(function(){return b.indexOf(Mb)==-1&&(b.indexOf(Nb)==-1&&(b.indexOf(Nb)==-1&&(b.indexOf(Yb)!=-1&&b.indexOf(Zb)!=-1)))}()){{m.$pdk.userAgentAxis=$b;return m.$pdk.userAgentAxis}}if(function(){return b.indexOf(Mb)==-1&&(b.indexOf(Nb)==-1&&(b.indexOf(_b)!=-1&&b.indexOf(Zb)!=-1))}()){{m.$pdk.userAgentAxis=ac;return m.$pdk.userAgentAxis}}if(function(){return b.indexOf(Nb)==-1&&(b.indexOf(Lb)==-1&&((b.indexOf(Yb)!=-1||b.indexOf(bc)!=-1)&&b.indexOf(Mb)!=-1))}()){{m.$pdk.userAgentAxis=cc;return m.$pdk.userAgentAxis}}if(function(){return b.indexOf(Nb)==-1&&(b.indexOf(_b)!=-1&&b.indexOf(Mb)!=-1)}()){{m.$pdk.userAgentAxis=dc;return m.$pdk.userAgentAxis}}if(function(){return b.indexOf(ec)!=-1&&(b.indexOf(fc)!=-1&&n.documentMode>=10)}()){{m.$pdk.userAgentAxis=gc;return m.$pdk.userAgentAxis}}if(function(){return b.indexOf(ec)!=-1&&n.documentMode>=10}()){{m.$pdk.userAgentAxis=hc;return m.$pdk.userAgentAxis}}if(function(){return b.indexOf(ec)!=-1&&n.documentMode>=9}()){{m.$pdk.userAgentAxis=ic;return m.$pdk.userAgentAxis}}if(function(){return b.indexOf(ec)!=-1&&n.documentMode>=8}()){{m.$pdk.userAgentAxis=jc;return m.$pdk.userAgentAxis}}if(function(){var a=/msie ([0-9]+)\.([0-9]+)/.exec(b);if(a&&a.length==3)return c(a)>=6000}()){{m.$pdk.userAgentAxis=kc;return m.$pdk.userAgentAxis}}if(function(){return b.indexOf(lc)!=-1&&b.indexOf(_b)!=-1}()){{m.$pdk.userAgentAxis=mc;return m.$pdk.userAgentAxis}}if(function(){return b.indexOf(lc)!=-1&&(b.indexOf(Yb)!=-1||b.indexOf(bc)!=-1)}()){{m.$pdk.userAgentAxis=nc;return m.$pdk.userAgentAxis}}if(function(){return b.indexOf(lc)!=-1}()){{m.$pdk.userAgentAxis=oc;return m.$pdk.userAgentAxis}}m.$pdk.userAgentAxis=cc;return cc};u[Kb]={chrome_android:0,chrome_mac:1,chrome_windows:2,gecko1_8:3,gecko1_8_mac:4,gecko1_8_windows:5,ie10:6,ie10_app:7,ie6:8,ie8:9,ie9:10,opera:11,safari:12,safari_android:13,safari_android_legacy:14,safari_ipad:15,safari_iphone:16,safari_mac:17,safari_windows:18};PDK.onScriptLoad=function(a){PDK.onScriptLoad=null;q=a;G()};if(F()){alert(pc+qc);return}I();H();o&&o({moduleName:V,sessionId:p,subSystem:W,evtGroup:X,millis:(new Date).getTime(),type:rc});var M;try{K([Ib,Jb,Jb,hc],sc);K([Ib,Jb,Ib,hc],sc);K([Ib,Jb,Jb,hc],sc+tc);K([Ib,Jb,Ib,hc],sc+tc);K([Ib,Ib,Jb,gc],uc);K([Ib,Ib,Ib,gc],uc);K([Ib,Ib,Jb,gc],uc+tc);K([Ib,Ib,Ib,gc],uc+tc);K([Jb,Ib,Jb,Tb],vc);K([Jb,Ib,Ib,Tb],vc);K([Jb,Ib,Jb,Tb],vc+tc);K([Jb,Ib,Ib,Tb],vc+tc);K([Jb,Jb,Jb,ic],wc);K([Jb,Jb,Ib,ic],wc);K([Jb,Jb,Jb,ic],wc+tc);K([Jb,Jb,Ib,ic],wc+tc);K([Ib,Jb,Jb,kc],xc);K([Ib,Jb,Ib,kc],xc);K([Ib,Jb,Jb,kc],xc+tc);K([Ib,Jb,Ib,kc],xc+tc);K([Jb,Ib,Jb,Rb],yc);K([Jb,Ib,Ib,Rb],yc);K([Jb,Ib,Jb,Rb],yc+tc);K([Jb,Ib,Ib,Rb],yc+tc);K([Ib,Ib,Jb,Tb],zc);K([Ib,Ib,Ib,Tb],zc);K([Ib,Ib,Jb,Tb],zc+tc);K([Ib,Ib,Ib,Tb],zc+tc);K([Jb,Jb,Jb,Tb],Ac);K([Jb,Jb,Ib,Tb],Ac);K([Jb,Jb,Jb,Tb],Ac+tc);K([Jb,Jb,Ib,Tb],Ac+tc);K([Jb,Jb,Jb,ac],Bc);K([Jb,Jb,Ib,ac],Bc);K([Jb,Jb,Jb,ac],Bc+tc);K([Jb,Jb,Ib,ac],Bc+tc);K([Jb,Ib,Jb,hc],Cc);K([Jb,Ib,Ib,hc],Cc);K([Jb,Ib,Jb,hc],Cc+tc);K([Jb,Ib,Ib,hc],Cc+tc);K([Jb,Jb,Jb,hc],Dc);K([Jb,Jb,Ib,hc],Dc);K([Jb,Jb,Jb,hc],Dc+tc);K([Jb,Jb,Ib,hc],Dc+tc);K([Jb,Ib,Jb,dc],Ec);K([Jb,Ib,Ib,dc],Ec);K([Jb,Ib,Jb,dc],Ec+tc);K([Jb,Ib,Ib,dc],Ec+tc);K([Ib,Ib,Jb,oc],Fc);K([Ib,Ib,Ib,oc],Fc);K([Ib,Ib,Jb,oc],Fc+tc);K([Ib,Ib,Ib,oc],Fc+tc);K([Ib,Ib,Jb,dc],Gc);K([Ib,Ib,Ib,dc],Gc);K([Ib,Ib,Jb,dc],Gc+tc);K([Ib,Ib,Ib,dc],Gc+tc);K([Ib,Jb,Jb,nc],Hc);K([Ib,Jb,Ib,nc],Hc);K([Ib,Jb,Jb,nc],Hc+tc);K([Ib,Jb,Ib,nc],Hc+tc);K([Jb,Ib,Jb,Zb],Ic);K([Jb,Ib,Ib,Zb],Ic);K([Jb,Ib,Jb,Zb],Ic+tc);K([Jb,Ib,Ib,Zb],Ic+tc);K([Ib,Ib,Jb,cc],Jc);K([Ib,Ib,Ib,cc],Jc);K([Ib,Ib,Jb,cc],Jc+tc);K([Ib,Ib,Ib,cc],Jc+tc);K([Ib,Jb,Jb,$b],Kc);K([Ib,Jb,Ib,$b],Kc);K([Ib,Jb,Jb,$b],Kc+tc);K([Ib,Jb,Ib,$b],Kc+tc);K([Jb,Jb,Jb,Sb],Lc);K([Jb,Jb,Ib,Sb],Lc);K([Jb,Jb,Jb,Sb],Lc+tc);K([Jb,Jb,Ib,Sb],Lc+tc);K([Jb,Ib,Jb,oc],Mc);K([Jb,Ib,Ib,oc],Mc);K([Jb,Ib,Jb,oc],Mc+tc);K([Jb,Ib,Ib,oc],Mc+tc);K([Jb,Jb,Jb,cc],Nc);K([Jb,Jb,Ib,cc],Nc);K([Jb,Jb,Jb,cc],Nc+tc);K([Jb,Jb,Ib,cc],Nc+tc);K([Ib,Jb,Jb,ic],Oc);K([Ib,Jb,Ib,ic],Oc);K([Ib,Jb,Jb,ic],Oc+tc);K([Ib,Jb,Ib,ic],Oc+tc);K([Ib,Ib,Jb,Xb],Pc);K([Ib,Ib,Ib,Xb],Pc);K([Ib,Ib,Jb,Xb],Pc+tc);K([Ib,Ib,Ib,Xb],Pc+tc);K([Jb,Jb,Jb,jc],Qc);K([Jb,Jb,Ib,jc],Qc);K([Jb,Jb,Jb,jc],Qc+tc);K([Jb,Jb,Ib,jc],Qc+tc);K([Ib,Jb,Jb,jc],Rc);K([Ib,Jb,Ib,jc],Rc);K([Ib,Jb,Jb,jc],Rc+tc);K([Ib,Jb,Ib,jc],Rc+tc);K([Ib,Jb,Jb,Tb],Sc);K([Ib,Jb,Ib,Tb],Sc);K([Ib,Jb,Jb,Tb],Sc+tc);K([Ib,Jb,Ib,Tb],Sc+tc);K([Ib,Ib,Jb,Zb],Tc);K([Ib,Ib,Ib,Zb],Tc);K([Ib,Ib,Jb,Zb],Tc+tc);K([Ib,Ib,Ib,Zb],Tc+tc);K([Ib,Jb,Jb,cc],Uc);K([Ib,Jb,Ib,cc],Uc);K([Ib,Jb,Jb,cc],Uc+tc);K([Ib,Jb,Ib,cc],Uc+tc);K([Ib,Jb,Jb,Sb],Vc);K([Ib,Jb,Ib,Sb],Vc);K([Ib,Jb,Jb,Sb],Vc+tc);K([Ib,Jb,Ib,Sb],Vc+tc);K([Ib,Ib,Jb,hc],Wc);K([Ib,Ib,Ib,hc],Wc);K([Ib,Ib,Jb,hc],Wc+tc);K([Ib,Ib,Ib,hc],Wc+tc);K([Ib,Jb,Jb,dc],Xc);K([Ib,Jb,Ib,dc],Xc);K([Ib,Jb,Jb,dc],Xc+tc);K([Ib,Jb,Ib,dc],Xc+tc);K([Jb,Ib,Jb,mc],Yc);K([Jb,Ib,Ib,mc],Yc);K([Jb,Ib,Jb,mc],Yc+tc);K([Jb,Ib,Ib,mc],Yc+tc);K([Jb,Ib,Jb,cc],Zc);K([Jb,Ib,Ib,cc],Zc);K([Jb,Ib,Jb,cc],Zc+tc);K([Jb,Ib,Ib,cc],Zc+tc);K([Ib,Ib,Jb,Ob],$c);K([Ib,Ib,Ib,Ob],$c);K([Ib,Ib,Jb,Ob],$c+tc);K([Ib,Ib,Ib,Ob],$c+tc);K([Jb,Jb,Jb,$b],_c);K([Jb,Jb,Ib,$b],_c);K([Jb,Jb,Jb,$b],_c+tc);K([Jb,Jb,Ib,$b],_c+tc);K([Jb,Ib,Jb,Sb],ad);K([Jb,Ib,Ib,Sb],ad);K([Jb,Ib,Jb,Sb],ad+tc);K([Jb,Ib,Ib,Sb],ad+tc);K([Ib,Ib,Jb,Vb],bd);K([Ib,Ib,Ib,Vb],bd);K([Ib,Ib,Jb,Vb],bd+tc);K([Ib,Ib,Ib,Vb],bd+tc);K([Ib,Jb,Jb,oc],cd);K([Ib,Jb,Ib,oc],cd);K([Ib,Jb,Jb,oc],cd+tc);K([Ib,Jb,Ib,oc],cd+tc);K([Jb,Jb,Jb,dc],dd);K([Jb,Jb,Ib,dc],dd);K([Jb,Jb,Jb,dc],dd+tc);K([Jb,Jb,Ib,dc],dd+tc);K([Ib,Jb,Jb,Rb],ed);K([Ib,Jb,Ib,Rb],ed);K([Ib,Jb,Jb,Rb],ed+tc);K([Ib,Jb,Ib,Rb],ed+tc);K([Jb,Ib,Jb,ic],fd);K([Jb,Ib,Ib,ic],fd);K([Jb,Ib,Jb,ic],fd+tc);K([Jb,Ib,Ib,ic],fd+tc);K([Ib,Ib,Jb,kc],gd);K([Ib,Ib,Ib,kc],gd);K([Ib,Ib,Jb,kc],gd+tc);K([Ib,Ib,Ib,kc],gd+tc);K([Jb,Jb,Jb,Xb],hd);K([Jb,Jb,Ib,Xb],hd);K([Jb,Jb,Jb,Xb],hd+tc);K([Jb,Jb,Ib,Xb],hd+tc);K([Ib,Jb,Jb,Vb],jd);K([Ib,Jb,Ib,Vb],jd);K([Ib,Jb,Jb,Vb],jd+tc);K([Ib,Jb,Ib,Vb],jd+tc);K([Ib,Jb,Jb,gc],kd);K([Ib,Jb,Ib,gc],kd);K([Ib,Jb,Jb,gc],kd+tc);K([Ib,Jb,Ib,gc],kd+tc);K([Jb,Ib,Jb,Xb],ld);K([Jb,Ib,Ib,Xb],ld);K([Jb,Ib,Jb,Xb],ld+tc);K([Jb,Ib,Ib,Xb],ld+tc);K([Ib,Ib,Jb,Rb],md);K([Ib,Ib,Ib,Rb],md);K([Ib,Ib,Jb,Rb],md+tc);K([Ib,Ib,Ib,Rb],md+tc);K([Ib,Ib,Jb,ic],nd);K([Ib,Ib,Ib,ic],nd);K([Ib,Ib,Jb,ic],nd+tc);K([Ib,Ib,Ib,ic],nd+tc);K([Jb,Jb,Jb,Vb],od);K([Jb,Jb,Ib,Vb],od);K([Jb,Jb,Jb,Vb],od+tc);K([Jb,Jb,Ib,Vb],od+tc);K([Jb,Jb,Jb,mc],pd);K([Jb,Jb,Ib,mc],pd);K([Jb,Jb,Jb,mc],pd+tc);K([Jb,Jb,Ib,mc],pd+tc);K([Ib,Ib,Jb,jc],qd);K([Ib,Ib,Ib,jc],qd);K([Ib,Ib,Jb,jc],qd+tc);K([Ib,Ib,Ib,jc],qd+tc);K([Ib,Jb,Jb,Zb],rd);K([Ib,Jb,Ib,Zb],rd);K([Ib,Jb,Jb,Zb],rd+tc);K([Ib,Jb,Ib,Zb],rd+tc);K([Ib,Ib,Jb,mc],sd);K([Ib,Ib,Ib,mc],sd);K([Ib,Ib,Jb,mc],sd+tc);K([Ib,Ib,Ib,mc],sd+tc);K([Jb,Ib,Jb,ac],td);K([Jb,Ib,Ib,ac],td);K([Jb,Ib,Jb,ac],td+tc);K([Jb,Ib,Ib,ac],td+tc);K([Ib,Ib,Jb,$b],ud);K([Ib,Ib,Ib,$b],ud);K([Ib,Ib,Jb,$b],ud+tc);K([Ib,Ib,Ib,$b],ud+tc);K([Ib,Ib,Jb,Sb],vd);K([Ib,Ib,Ib,Sb],vd);K([Ib,Ib,Jb,Sb],vd+tc);K([Ib,Ib,Ib,Sb],vd+tc);K([Ib,Jb,Jb,Ob],wd);K([Ib,Jb,Ib,Ob],wd);K([Ib,Jb,Jb,Ob],wd+tc);K([Ib,Jb,Ib,Ob],wd+tc);K([Jb,Ib,Jb,$b],xd);K([Jb,Ib,Ib,$b],xd);K([Jb,Ib,Jb,$b],xd+tc);K([Jb,Ib,Ib,$b],xd+tc);K([Jb,Jb,Jb,gc],yd);K([Jb,Jb,Ib,gc],yd);K([Jb,Jb,Jb,gc],yd+tc);K([Jb,Jb,Ib,gc],yd+tc);K([Jb,Jb,Jb,Ob],zd);K([Jb,Jb,Ib,Ob],zd);K([Jb,Jb,Jb,Ob],zd+tc);K([Jb,Jb,Ib,Ob],zd+tc);K([Jb,Ib,Jb,Vb],Ad);K([Jb,Ib,Ib,Vb],Ad);K([Jb,Ib,Jb,Vb],Ad+tc);K([Jb,Ib,Ib,Vb],Ad+tc);K([Jb,Jb,Jb,oc],Bd);K([Jb,Jb,Ib,oc],Bd);K([Jb,Jb,Jb,oc],Bd+tc);K([Jb,Jb,Ib,oc],Bd+tc);K([Jb,Jb,Jb,Rb],Cd);K([Jb,Jb,Ib,Rb],Cd);K([Jb,Jb,Jb,Rb],Cd+tc);K([Jb,Jb,Ib,Rb],Cd+tc);K([Jb,Ib,Jb,Ob],Dd);K([Jb,Ib,Ib,Ob],Dd);K([Jb,Ib,Jb,Ob],Dd+tc);K([Jb,Ib,Ib,Ob],Dd+tc);K([Jb,Jb,Jb,nc],Ed);K([Jb,Jb,Ib,nc],Ed);K([Jb,Jb,Jb,nc],Ed+tc);K([Jb,Jb,Ib,nc],Ed+tc);K([Jb,Jb,Jb,Zb],Fd);K([Jb,Jb,Ib,Zb],Fd);K([Jb,Jb,Jb,Zb],Fd+tc);K([Jb,Jb,Ib,Zb],Fd+tc);K([Ib,Jb,Jb,Xb],Gd);K([Ib,Jb,Ib,Xb],Gd);K([Ib,Jb,Jb,Xb],Gd+tc);K([Ib,Jb,Ib,Xb],Gd+tc);K([Jb,Ib,Jb,jc],Hd);K([Jb,Ib,Ib,jc],Hd);K([Jb,Ib,Jb,jc],Hd+tc);K([Jb,Ib,Ib,jc],Hd+tc);K([Ib,Ib,Jb,nc],Id);K([Ib,Ib,Ib,nc],Id);K([Ib,Ib,Jb,nc],Id+tc);K([Ib,Ib,Ib,nc],Id+tc);K([Ib,Jb,Jb,mc],Jd);K([Ib,Jb,Ib,mc],Jd);K([Ib,Jb,Jb,mc],Jd+tc);K([Ib,Jb,Ib,mc],Jd+tc);K([Jb,Ib,Jb,kc],Kd);K([Jb,Ib,Ib,kc],Kd);K([Jb,Ib,Jb,kc],Kd+tc);K([Jb,Ib,Ib,kc],Kd+tc);K([Jb,Ib,Jb,gc],Ld);K([Jb,Ib,Ib,gc],Ld);K([Jb,Ib,Jb,gc],Ld+tc);K([Jb,Ib,Ib,gc],Ld+tc);K([Jb,Jb,Jb,kc],Md);K([Jb,Jb,Ib,kc],Md);K([Jb,Jb,Jb,kc],Md+tc);K([Jb,Jb,Ib,kc],Md+tc);K([Ib,Jb,Jb,ac],Nd);K([Ib,Jb,Ib,ac],Nd);K([Ib,Jb,Jb,ac],Nd+tc);K([Ib,Jb,Ib,ac],Nd+tc);K([Ib,Ib,Jb,ac],Od);K([Ib,Ib,Ib,ac],Od);K([Ib,Ib,Jb,ac],Od+tc);K([Ib,Ib,Ib,ac],Od+tc);K([Jb,Ib,Jb,nc],Pd);K([Jb,Ib,Ib,nc],Pd);K([Jb,Ib,Jb,nc],Pd+tc);K([Jb,Ib,Ib,nc],Pd+tc);M=w[L(Db)][L(Eb)][L(Fb)][L(Kb)];var N=M.indexOf(Qd);if(N!=-1){A=Number(M.substring(N+1));M=M.substring(0,N)}}catch(a){return}var O;function P(){if(!r){r=true;G();if(n.removeEventListener){n.removeEventListener(Rd,P,false)}if(O){clearInterval(O)}}}
...
$pdk.bootloaderVersion=new $pdk.PdkVersion("5","6","2","393182","2015-04-13 10:24 AM");
...
$pdk.shell.Factory.CLASS_TABLE={tpHeader:b.Header,tpReleaseList:b.ReleaseList,tpReleaseModel:b.ReleaseModel,tpPlayer:b.Player,tpClipInfo:b.ClipInfo,tpCategoryList:b.CategoryList,tpSearch:b.Search,tpNavigation:b.Navigation,tpCategoryModel:b.CategoryModel};
...
a.setLicenseServer=function(d,c,e){this._regFunc("setLicenseServer",["java.lang.String","java.lang.String"],[d,c],e)
};
...
a.getMediaArea=function(c){this._regFunc("getMediaArea",[],[],c)
};
...
a.getOverlayArea=function(f,c,e,d){this._regFunc("getOverlayArea",["boolean","boolean","boolean"],[f,c,e],d)
};
...
a.getContentArea=function(c){this._regFunc("getContentArea",[],[],c)
};
...
/*
     ...
     INTERNET ARCHIVE ON 17:12:22 Dec 29, 2025.
...
playback timings (ms):
  ...
  esindex: 0.01
  cdx.remote: 18.558
  LoadShardBlock: 153.81 (3)
  PetaboxLoader3.datanode: 161.576 (4)
  load_resource: 42.841
*/